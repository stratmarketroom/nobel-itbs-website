...
import type { ActivateCredentialInput } from '@/lib/credentials/activation-types';
...
export async function readActivateCredentialInput(request: Request): Promise<ActivateCredentialInput> {
