...
- General Psychology and Child Psychology now have the Owner-approved Leeloo URLs in dev and Production; PR #17 was merged as `f8b6267`, and Preview plus post-merge Production acceptance passed across EN/UA/CZ. Space Business still requires its final destination.
...
- Remaining pre-launch work is operational: one approved real VEDOS credential-delivery acceptance, Telegram secret configuration and transport acceptance, final CTA destinations, analytics/consent, activation and drill of database/private-PDF backups, canonical-domain verification, and final physical-device/accessibility/cross-browser acceptance. Conditional CAPTCHA remains disabled unless abuse signals justify it.
