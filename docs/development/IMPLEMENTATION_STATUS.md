...
- Remaining pre-launch work is operational: one approved real VEDOS credential-delivery acceptance, Telegram secret configuration and transport acceptance, analytics/consent, activation and drill of database/private-PDF backups, canonical-domain verification, and final physical-device/accessibility/cross-browser acceptance. Conditional CAPTCHA remains disabled unless abuse signals justify it.
