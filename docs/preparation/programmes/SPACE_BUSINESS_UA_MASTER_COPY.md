...
`body`: Після виконання умов програми слухач отримує сертифікат. Space Business представлена в каталозі Nobel ITBS як сертифікатна програма.
...
Після виконання умов програми видається сертифікат.
