...
`seo_description`: A six-month Mini-MBA programme on creating, launching and scaling expert products with marketing, sales and AI. 360 hours, 12 ECTS.

`og_title`: AI Production — A Mini-MBA for Expert Product Launches

`og_description`: Build a system for creating, launching and scaling a product through marketing, sales, management and AI.
...
`supporting_copy`: The programme combines product strategy, marketing, sales, financial planning, team management and the practical use of AI. Throughout your learning, you progressively build your own system for launching an expert-led or educational product.

`primary_cta`: Ask a question

## Programme Facts

- Total scope: 360 hours, 12 ECTS
- Type: Mini-MBA
- Duration: 6 months
...
1. Strategic methodology for launching an expert-led project
...
### After 3 months: university certificate
...
No. The technical component focuses on the applied use of AI, digital platforms and no-code tools.

### Will I create my own product during the programme?

Yes. The practical assignments build a launch portfolio, and the final project brings it together into a complete strategy.

### What is the language of instruction?

The programme is taught in Ukrainian. The English and Czech website versions present the same Ukrainian-language programme.

### What document will I receive?

After the first 3 months, you receive a professional development certificate from the University of Alfred Nobel confirming 180 hours / 6 ECTS. After completing the full six-month programme, you receive an international `Mini-MBA | Professional Development` diploma from Nobel ITBS with a Diploma Supplement. The complete programme has a total scope of 360 hours / 12 ECTS.
...
- approve the final Ukrainian public title used in navigation;
- prepare an optimized web derivative of Dmytro Shevchuk's approved photograph;
- keep programme pricing on the Dmytro Shevchuk partner website rather than duplicating it on Nobel ITBS;
- add the specific MBA credit-transfer terms when the admissions regulations are ready; the possibility of credit transfer itself has been confirmed;
- do not publish the claim that the outcome usually requires 1.5-2 years of study without a defined comparison basis and evidence;
