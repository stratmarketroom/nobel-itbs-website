# Neuroplastic Reconstruction: EN Master Copy
...
`seo_description`: A professional development programme in neuroplasticity, self-regulation and behavioural patterns. 3 months, 180 hours, 6 ECTS.

`og_title`: Neuroplastic Reconstruction — Neuroplasticity and Self-Regulation

`og_description`: Explore self-regulation, behavioural patterns and the Neuroplastic Reconstruction method across 12 modules.
...
- people who want to better understand their reactions, emotions, needs and behavioural patterns;
...
- explain the basic mechanisms of neuroplasticity and psychological regulation;
...
### Stage 1. Foundations of the method and personal application
...
`internal_note_not_for_publication`: The approved public programme structure contains 12 modules in three stages.
...
`internal_note_not_for_publication`: The inclusion of AI Nataliia and a second AI tool in the Master and VIP packages has been confirmed. The landing page uses both `AI neuroplasticity` and `AI neurofeedback` for the second tool; before final publication, approve one name, a functional description, access period, privacy rules and professional limitations.
...
`internal_note_not_for_publication`: This section is partner-site reference only. Nobel ITBS does not duplicate current prices or sell the programme; its CTA links to the partner website.

`heading`: Choose your participation format

`start_date`: 5 October 2026

### Personal

- Current price: EUR 990
- Previous price shown on the landing page: EUR 1,990
- Access to materials: 3 months after the programme ends
- 7 programme modules
- Weekly live sessions with Nataliia Kholodenko as an observer
- Option to attend the graduation ball in Vienna for a separate organisational fee
- No certification documents, practical certification or MNR consultant status

### Master

- Current price: EUR 1,390
- Previous price shown on the landing page: EUR 2,490
- Access to materials: 6 months after the programme ends
- All 12 programme modules
- Weekly live sessions with the opportunity to ask questions
- Demonstration sessions, small groups and tutor review of homework
- AI Nataliia and a second AI tool for personal and client use; the final name will be added after approval
- University of Alfred Nobel certificate with supplement
- International CPD UK certificate
- Status and entry in the register of certified MNR consultants
- Option to attend the graduation ball in Vienna for a separate organisational fee

### VIP

- Current price: EUR 2,090
- Previous price shown on the landing page: EUR 3,490
- Everything included in the Master package
- Access to materials: 1 year after the programme ends
- Two-day practical workshop in Vienna with Nataliia Kholodenko and experts
- Certificate confirming 12 hours of supervision after the workshop
- Workshop recording, personal VIP tutor and a separate VIP chat

`booking_note`: The current landing page offers reservations for EUR 100. The reservation amount is non-refundable if the participant withdraws.

`cta_note`: The primary CTA links to the Nataliia Kholodenko school website at `https://school.kholodenko.net/`.

## FAQ

### Can I enrol without a psychology background?

Yes. For learners without a foundational psychology education, the programme can provide a personal-development pathway and an introduction to the method. Completing the programme does not make a graduate a psychologist or authorise psychotherapy or medical practice.

### Does the programme include practical activities?

Yes. It includes self-regulation exercises, case analysis, role-play counselling simulations and a practice-oriented final project.

### Does the programme teach participants to treat anxiety or depression?

No. The programme considers psychological mechanisms and approaches to support, but does not replace medical diagnosis, treatment or specialist psychotherapy training.

### How much time does learning require each week?

The estimated workload is 5-7 hours per week plus independent work. The programme combines video materials, live sessions, demonstration sessions and practical assignments.

### Can I counsel clients after completing the programme?

The Master and VIP packages include preparation, certification and MNR method consultant status after the learning and assessment requirements are met. This status is not equivalent to the profession of psychologist, psychotherapist or medical professional.

### What is the language of instruction?

The programme is taught in Ukrainian. The English and Czech pages present the same Ukrainian-language programme.

### What document will I receive?

The Personal package does not include certification documents. After successful completion of the Master or VIP package, participants receive a professional development certificate from the University of Alfred Nobel confirming 180 hours / 6 ECTS, a certificate supplement and an international CPD UK certificate.
...
These items are not part of the public copy submitted for approval:

- confirm the public list of lecturers;
- confirm the name and format of the learning community;
- prepare privacy, safety and professional-use rules for AI Nataliia and AI neurofeedback;
- confirm the terms for using the MNR consultant logo;
- add a legally approved note on the boundaries of counselling practice by country;
- keep `https://school.kholodenko.net/` as the approved programme destination unless a more specific partner landing URL is supplied.
