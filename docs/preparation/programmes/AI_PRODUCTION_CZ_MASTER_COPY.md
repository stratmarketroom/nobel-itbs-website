...
`seo_description`: Šestiměsíční program Mini-MBA o vytváření, uvádění na trh a škálování expertních produktů s marketingem, prodejem a AI. 360 hodin, 12 ECTS.

`og_title`: AI Production — Mini-MBA pro expertní produkty

`og_description`: Vytvořte systém pro tvorbu, uvedení na trh a škálování produktu pomocí marketingu, prodeje, managementu a AI.

## Hero
`eyebrow`: Mini-MBA | Business & Management
`h1`: AI Production
`lead`: Proměňte odbornost v silný produkt a uvedení na trh v řiditelný obchodní systém.
`supporting_copy`: Program propojuje produktovou strategii, marketing, prodej, finanční plánování, řízení týmu a praktické využití AI. Během studia postupně vytváříte vlastní systém pro uvedení expertního nebo vzdělávacího produktu na trh.
`primary_cta`: Položit dotaz

## Programme Facts
- Celkový rozsah: 360 hodin, 12 ECTS
- Typ: Mini-MBA
- Délka: 6 měsíců
...
1. Strategická metodologie uvedení expertního projektu na trh
...
### Po 3 měsících: univerzitní certifikát
...
## FAQ
### Potřebuji zkušenosti s produkcí?
...
Ne. Technická část se soustředí na praktické využití AI, digitálních platforem a no-code nástrojů.
### Budu během studia vytvářet vlastní produkt?
Ano. Praktické úkoly vytvářejí portfolio a závěrečný projekt je propojí do ucelené strategie.
### V jakém jazyce probíhá výuka?
V ukrajinštině. Anglická a česká verze webu představují stejný ukrajinsky vyučovaný program.
### Jaké dokumenty získám?
Po 3 měsících certifikát Univerzity Alfreda Nobela na 180 hodin / 6 ECTS; po 6 měsících mezinárodní diplom `Mini-MBA | Professional Development` od Nobel ITBS s Diploma Supplement. Celkem 360 hodin / 12 ECTS.
...
- schválit konečný ukrajinský veřejný název v navigaci;
- připravit optimalizovanou webovou variantu schválené fotografie Dmytra Shevchuka;
- cenu programu ponechat na partnerském webu Dmytra Shevchuka a neduplikovat ji na Nobel ITBS;
- doplnit pravidla uznání do MBA, až budou připravena;
- nepublikovat tvrzení o 1,5-2 letech bez podkladů;
- zachovat kontaktní CTA.
