# Neuroplastic Reconstruction: CZ Master Copy
...
`seo_description`: Program profesního rozvoje v oblasti neuroplasticity, seberegulace a behaviorálních vzorců. 3 měsíce, 180 hodin, 6 ECTS.

`og_title`: Neuroplastic Reconstruction — neuroplasticita a seberegulace

`og_description`: Poznejte seberegulaci, behaviorální vzorce a metodu Neuroplastic Reconstruction ve 12 modulech.

## Hero
`eyebrow`: Program profesního rozvoje
`h1`: Neuroplastic Reconstruction
`lead`: Porozumějte svým reakcím, osvojte si nástroje seberegulace a poznejte metodu neuroplastické rekonstrukce.
`supporting_copy`: Program propojuje současné poznatky o neuroplasticitě s praxí seberegulace, prací s obrazy a behaviorálními vzorci, strukturou poradenského rozhovoru a etickými hranicemi pomoci.
`primary_cta`: Přejít na web programu

## Programme Facts
- Rozsah: 180 hodin, 6 ECTS
...
- lidem, kteří chtějí lépe rozumět svým reakcím, emocím, potřebám a vzorcům;
...
- vysvětlit základy neuroplasticity a psychické regulace;
...
### Etapa 1. Základy metody a osobní použití
...
`internal_note_not_for_publication`: Tato část slouží pouze jako reference z partnerského webu. Nobel ITBS neduplikuje aktuální ceny ani program neprodává; CTA vede na web partnera.
`heading`: Zvolte si formát účasti
`start_date`: 5. října 2026
### Pro sebe
- Aktuální cena: 990 EUR
- Předchozí cena na landing page: 1 990 EUR
- Přístup k materiálům: 3 měsíce po skončení výuky
- 7 modulů programu
- Týdenní live setkání s Nataliiou Kholodenko v roli pozorovatele
- Možnost účasti na absolventském plese ve Vídni za samostatný organizační
  poplatek
- Bez certifikačních dokumentů, praktické certifikace a statusu konzultanta MNR
### Master
- Aktuální cena: 1 390 EUR
- Předchozí cena na landing page: 2 490 EUR
- Přístup k materiálům: 6 měsíců po skončení výuky
- Všech 12 modulů programu
- Týdenní live setkání s možností klást otázky
- Demonstrační setkání, malé skupiny a kontrola domácích úkolů tutory
- AI Nataliia a druhý AI nástroj pro vlastní použití i práci s klienty; konečný
  název bude doplněn po schválení
- Certifikát Univerzity Alfreda Nobela s dodatkem
- Mezinárodní certifikát CPD UK
- Status a zápis v registru certifikovaných konzultantů MNR
- Možnost účasti na absolventském plese ve Vídni za samostatný organizační
  poplatek
### VIP
- Aktuální cena: 2 090 EUR
- Předchozí cena na landing page: 3 490 EUR
- Vše, co zahrnuje varianta Master
- Přístup k materiálům: 1 rok po skončení výuky
- Dvoudenní praktikum ve Vídni s Nataliiou Kholodenko a experty
- Certifikát o 12 hodinách supervize po praktiku
- Záznam praktika, osobní VIP tutor a samostatný VIP chat
`booking_note`: Aktuální landing page umožňuje rezervaci za 100 EUR; při odstoupení je částka nevratná.
`cta_note`: Hlavní CTA odkazuje na web školy Nataliie Kholodenko `https://school.kholodenko.net/`.

## FAQ
### Mohu studovat bez psychologického vzdělání?
Ano, pro osobní rozvoj a seznámení s metodou. Dokončení z absolventa nedělá psychologa a neopravňuje k psychoterapeutické ani zdravotnické praxi.
### Obsahuje program praktickou výuku?
Ano, cvičení seberegulace, analýzu případů, simulace konzultací a prakticky zaměřený závěrečný projekt.
### Učí program léčit úzkost nebo depresi?
Ne. Nenahrazuje zdravotnickou diagnostiku, léčbu ani odborný psychoterapeutický výcvik.
### Kolik času vyžaduje týdně?
Přibližně 5-7 hodin plus samostatná práce.
### Mohu po programu pracovat s klienty?
Master/VIP zahrnují přípravu a status konzultanta MNR po splnění podmínek. Status není rovnocenný profesi psychologa, psychoterapeuta ani zdravotníka.
### V jakém jazyce probíhá výuka?
V ukrajinštině. Anglická a česká stránka představují stejný ukrajinsky vyučovaný program.
### Jaké dokumenty získám?
Pro sebe dokumenty nezahrnuje. Master/VIP zahrnují certifikát Univerzity Alfreda Nobela na 180 hodin / 6 ECTS, dodatek a CPD UK.
...
- potvrdit veřejný seznam lektorů a komunitu;
- připravit pravidla soukromí a bezpečného profesního použití AI;
- potvrdit použití loga konzultanta MNR;
- doplnit právně schválené hranice poradenské praxe podle zemí;
- zachovat `https://school.kholodenko.net/` jako schválený cíl programu, dokud partner neposkytne přesnější landing URL.
