...
- [-] ADM-EML-001 protected EN/UA credential-delivery template editor: role-aware admin UI/API, Owner/Super Admin/Credential Manager plus MFA/AAL2, controlled database mutation, privacy-minimal audit, and migration 67 accepted in Development and Production at 67/67 parity with focused pgTAP 19/19 in each environment. PR #50 and authenticated Owner/AAL2 Preview desktop/mobile acceptance pass; merge and Production deployment remain.
