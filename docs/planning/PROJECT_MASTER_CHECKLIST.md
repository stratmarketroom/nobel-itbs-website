...
35. [-] **QA-005 final programme CTA destinations** — General Psychology and Child Psychology URLs are approved and applied to dev and Production through a guarded migration; AI Production intentionally remains on question fallback. PR #17 Preview acceptance passed across EN/UA/CZ without opening an external form. Complete post-merge Production browser acceptance. See `docs/qa/QA_005_PROGRAMME_CTA_ACCEPTANCE_2026-08-24.md`.
