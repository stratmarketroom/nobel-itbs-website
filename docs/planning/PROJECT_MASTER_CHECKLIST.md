...
- [-] QA-005-A11Y-001 completed the audit-only public accessibility/reflow pass on 2026-08-24. The checked EN/UA/CZ public surface passed the available Chromium semantic, accessible-name, ARIA, focus, reduced-motion, 1280/390/320-pixel reflow, and horizontal-overflow checks. Final acceptance remains open because `/admin/login` has no CSS implementation for its `auth-*` classes and renders browser-default 22-pixel-high inputs; Safari, physical-device, assistive-technology, and complete manual keyboard evidence are also outstanding. See `docs/qa/QA_005_ACCESSIBILITY_CROSS_BROWSER_2026-08-24.md`.
...
- [-] Responsive/mobile, accessibility, localized error-state, and production-browser QA. Vercel Production Chromium acceptance passed across the earlier 27-route EN/UA/CZ mobile and 18-route desktop matrices; the 2026-08-24 focused audit also passed the checked public semantic/reflow scope at 1280, 390, and 320 CSS-pixel widths. Final acceptance remains open for `QA-005-A11Y-FIX-001` on the unstyled Admin Login and for Safari, physical-device, assistive-technology, complete manual keyboard, and post-fix Production evidence. See `docs/qa/QA_005_MOBILE_TOUCH_TARGETS_2026-08-12.md`, `docs/qa/QA_005_PRODUCTION_PUBLIC_ACCEPTANCE_2026-08-12.md`, `docs/qa/QA_005_SEO_PUBLICATION_2026-08-24.md`, and `docs/qa/QA_005_ACCESSIBILITY_CROSS_BROWSER_2026-08-24.md`.
...
- [x] As of QA-005-CTA-001 on 2026-08-24, all 67 non-live static verifiers, ESLint, `tsc --noEmit`, and the current production build pass.
...
37. [-] **QA-005 accessibility and cross-browser audit** — the checked public EN/UA/CZ Chromium semantic and 1280/390/320-pixel reflow scope passed, but `/admin/login` is missing all `auth-*` styling and cannot be accepted with browser-default 22-pixel-high inputs. Safari, physical-device, assistive-technology, and complete manual keyboard evidence remain open. See `docs/qa/QA_005_ACCESSIBILITY_CROSS_BROWSER_2026-08-24.md`.
38. **QA-005-A11Y-FIX-001, then continue operational launch readiness** — correct and deploy the Admin Login presentation/touch targets, repeat focused acceptance, then acceptance-test one approved real VEDOS credential delivery, revoke/replace the setup-time Telegram group invitation link, activate and drill database/private-PDF backups, attach and verify the canonical domain, configure analytics/consent, complete Safari/physical-device/assistive-technology acceptance, and make the final release decision. Telegram contact alerts are accepted.
