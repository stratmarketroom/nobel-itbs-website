...
41. [-] **Implement automatic credential document generation** — PDFGEN-001 through PDFGEN-007 are merged and accepted at their documented environment level. PDFGEN-008 points 1–4 and the separate editorial MFA/RLS correction pass locally and at their documented Development level. PDFGEN-LINT-001 migration 63 corrects the single-generation composite assignment, and LRN-LINT-001 migration 64 closes the last hosted schema-lint finding. Development parity is 64/64 with no schema lint errors. Production promotion of migrations 61–64, 200/540/1000 cohort mutation acceptance, and real VEDOS complete-package delivery remain open. See `docs/qa/PDFGEN_008_GENERATION_SECURITY_ACCEPTANCE_2026-08-27.md`, `docs/qa/PDFGEN_LINT_001_SINGLE_GENERATION_PACKAGE_ASSIGNMENT_2026-08-27.md`, and `docs/qa/LRN_LINT_001_IMPORT_LEARNERS_RELATION_RESOLUTION_2026-08-27.md`.
42. [x] **LRN-LINT-001 Import Learners Relation Resolution** — migration 64 removes the lint-invisible temporary staging relation and fixes the real second-call-in-one-transaction failure without changing the LRN-005 public contract, authorization, audit privacy, or data rules. The clean local rebuild, local/hosted selected gates pass 111/111, hosted lint is clean, and Development parity is 64/64. Production remains at 60.
