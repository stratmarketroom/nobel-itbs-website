...
- perform one separately approved real complete-package activation and VEDOS delivery acceptance with an authorized MFA actor; backup activation/restore remains gated before operational issuance;
